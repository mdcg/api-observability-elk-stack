...
from task_service.infrastructure.database.models.task_model import TaskModel # noqa
...
def run_migrations_online() -> None:
    ...
    db_config["sqlalchemy.url"] = context.get_x_argument(as_dictionary=True).get("DB_URL")
